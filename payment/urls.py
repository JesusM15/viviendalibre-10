...
urlpatterns = [
    ...
    path('generar-subscripcion-premium/<str:plan_id>/', views.generar_subscripcion, name='generar_subscripcion'),
    path('paypal/subscriptions/webhook/', views.webhook, name='webhook_paypal'),    
    path('subscripcion-premium/exitosa/', views.pago_exitoso, name='pago_exitoso'),
    path('subscripcion-premium/fallida/', views.pago_fallido, name='pago_fallido'),
]